 ...
 * 
 */  
public class SocketChannelClientTest1 {  
    ...
    public static void main(String[] args) throws Exception {  
        ...
        SocketChannelClientTest1 client = new SocketChannelClientTest1();  
        client.start("127.0.0.1", SocketChannelServerTest1.PORT_NUMBER);  
